...
//					'post_types' 		=> array('post', 'page'),
	...
	<div id="<?php echo $block_id; ?>" class="<?php if( !empty($block_align) ) { echo 'align-' . $block_align; } ?> block-<?php echo $block_name; ?>">
		<div class="bannerimage">
			<div class="imaget">
				<img src="<?php echo wp_get_attachment_url(115); ?>"> 
				...
				<div class="Maintxt">
					...
					<div class="buttonsban">
						...
						<a href="<?php echo get_permalink(68); ?>"><button class="button2">Contact Me</button></a> <!-- //TODO Setup Permalinks to work so this can work -->
					</div>
